...
const Hero = () => {
  return (
    <div className="flex pl-[100px] items-center justify-between pr-[100px]">
      ...
      <div className="w-[550px] h-auto relative">
        <div className="w-full  h-auto  shadow1 z-[9]">
          <img className="w-full -rotate-[25deg] trans h-auto object-contain " src={img} alt="main/img" />
        </div>
        <button className="flex absolute top-0 -left-[50px] bg-[#7b29dd] items-center gap-[15px] py-[10px] px-[25px] rounded-lg circle">
        ...
        <button className="bg-[#7a29df] absolute right-0 -bottom-[150px] flex items-center gap-[10px] py-[10px] px-[15px] rounded-xl">
