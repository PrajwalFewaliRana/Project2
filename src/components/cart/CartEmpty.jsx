...
import img from "../../assets/emptybag.png"
import {HiOutlineArrowNarrowLeft} from "react-icons/hi"

const CartEmpty = ({onCartToggle}) => {
  return (
    <div className='flex items-center justify-center flex-col h-screen px-11 text-center gap-7'>
      <img src={img} alt="emptybag/img" className='w-40 h-auto object-fill transition-all duration-300 hover:scale-110' />
      ...
      <HiOutlineArrowNarrowLeft className='w-5 h-5 text-slate-900' />
