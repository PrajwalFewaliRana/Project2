    ...
    <div className='flex bg-[#f1eeff] gap-[170px] pl-[100px] py-[30px]'>
      {
        servicesapi.map((item)=>(
          <div key={item.id} className='flex items-center 2xl:gap-[10px] gap-[18px]'>
            <div className='bg-[#fdc400] text-[47px] p-[10px] rounded-md'>{item.icon}</div>
            <div>
              <h1 className='poppins font-semibold text-[30px] 2xl:text-[27px] leading-tight'>{item.title}</h1>
