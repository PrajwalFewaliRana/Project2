...
import { selectCartItems, selectCartState, selectTotalAmount, selectTotalQTY, setClearCartItems, setCloseCart, setGetTotal } from "../store/CartSlice";
  ...
  return (
    <>
      ...
      >
        ...
        >
          <CartCount totalQTY={totalQTY} onCartToggle={onCartToggle} onClearCart={onClearCart}/>
          {
            cartItems.length ===0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
              <div className="flex items-start justify-start flex-col gap-y-7 overflow-y-scroll h-[81vh] scroll-smooth scroll-hidden py-3">
                {
              ...
              <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
                <div className="flex items-center justify-between">
                  <h1 className="text-base font-semibold uppercase">{totalQTY}</h1>
